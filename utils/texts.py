...
class texts:
    ...
    new_chat_added = lambda commands_url : f"""✅ Я так рад, что меня добавили. Пока я признаю команды только админов этого чата.
⚙️ Со списком всех команд можно ознакомиться в нашей статье
{commands_url}

А еще, прошу вас выдать мне права админа, для начала работы бота! Спасибо!^^
"""
